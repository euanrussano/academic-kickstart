...
Recalling, the problem is to maximize profit in the solvent extraction process by manipulating some system variables. The definition of the process can be found <a href="/20180804optimizationExcel/#more">**here**</a>, under Example 1.2. This problem can be divided into two parts:
...
**Download the Jupyter notebook of this post <a href="/data/20180804optimizationPython/20180804optimizationPython.ipynb">here!</a>**
**Download the Python code of this post <a href="/data/20180804optimizationPython/20180804optimizationPython.py">here!</a>**
